...
function calculateSum(n) {
  ...
  return sum; sending
  sending// Ініціалізувати змінну sum зі значенням 0
  // Запустити цикл для змінної i від 1 до n
  // Додати поточне значення i до змінної sum
  // Повернути значення змінної sum
}
...
// Задача 3: Напишіть функцію, яка перевіряє, чи є задане число простим(ділиться 
//без остачі тільки на себе та на 1).
...
// Задача 8: Напишіть функцію getUserStatus, яка приймає вік користувача age і повертає рядок, 
//що вказує на його статус.
// Якщо вік менше 18 років, функція повертає "Неповнолітній". Якщо вік від 18 до 65 років, функція повертає
// "Дорослий". Якщо вік більше або дорівнює 65 рокам, функція повертає "Пенсіонер".
...
// Задача 9: Напишіть функцію getDayOfWeek, яка приймає номер дня тижня dayNumber (1-7) і повертає рядок, 
//що відповідає цьому дню тижня.
